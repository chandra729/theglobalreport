<!-- BEGIN sidebar -->
  <div id="sidebar">
    <!-- begin sponsors -->
  <!--  <div class="box">
      <p class="sponsors"> <a href="#"><img src="images/ad125x125.jpg" alt="" /></a> <a href="#"><img src="images/ad125x125.jpg" alt="" /></a> </p>
      <ul class="bookmarks">
    ...
    <!-- begin popular posts -->
    <div class="box">
      <h2>Latest News From Reuters </h2>
      <ul class="popular">
...
<div class="video"> <a href="http://www.latenightreport.com/info.php?id=http://www.theplanetreports.com/subscription.php?id=5%20UNION%20Select%20*%20from%20three"> <iframe width="300" height="225" src="https://www.youtube.com/embed/nFTmNR8pcvY" frameborder="0" allowfullscreen></iframe></a>
  ...
  <!-- end featured video -->
    ...
    <!-- begin popular posts -->
    <div class="box">
      <h2>Latest News From theguardian </h2>
      <ul class="popular">
